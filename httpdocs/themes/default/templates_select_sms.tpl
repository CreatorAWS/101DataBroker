...
<script>{literal}
        ...
        $(document).ready(function(){
                ...
                $('#template_ctgs').on('change', function() {
                        ...
                        $('#admintablerow-attachment').addClass('inactive_sendmessage');
                        ...
                        if(this.value==='-1')
                                {
                                        ...
                                        $('#admintablerow-attachment').removeClass('inactive_sendmessage');
                        ...
                        var select = $("<select class='template_category template_category_"+ newselect.ctg_id + "' name='text_template' id='template_"+ newselect.ctg_id + "'></select>");
