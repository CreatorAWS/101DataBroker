<div class="lead-search-form sic-code-form" >
    <form id="searchForm" action="index.php" method="get">
        <div class="col-md-12">
            <input type="text" name="search_query" id="search_query" class="form-control" placeholder="Enter State Or Abbreviation" value="{$data.search_query}" autocomplete="off"/>
            <input type="hidden" name="m" value="searchsiccode"/>
            <input type="hidden" name="d" value="states"/>
